//
//  R_iphone5help2ViewController.m
//  RelianceApplication
//
...
@interface R_iphone5help2ViewController ()

@end

@implementation R_iphone5help2ViewController
...
-(void)loadtable
{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(10, 70, 300, 504) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGRect tableFrame = CGRectMake(10, 70, 300, size.height+50);
