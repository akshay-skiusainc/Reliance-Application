...
@interface iphone5GroupViewController ()

@end

@implementation iphone5GroupViewController
@synthesize dividerImage,titleImageBackground,titlelabel,livechatgroup;
...
-(void)DisplayGroups
{
	...
	VideoScroller			= [[UIScrollView alloc] initWithFrame:CGRectMake(10,44,299,470-30)];
	...
	for (int i =0; i<TotalData; i++) {
        ...
        ImagePatch[i]                    = [[UIImageView alloc] initWithFrame:CGRectMake(299-123, m+100-57, 118,47)];
