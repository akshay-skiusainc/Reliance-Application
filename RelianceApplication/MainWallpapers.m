...
@interface MainWallpapers ()

@end

@implementation MainWallpapers
...
-(void)back {
        ...
        
    {
        ...
        if(shareButton[a].alpha ==1.0 |  _IAPVIEW.alpha==1.0)
...
//        
//        downloadButton[a].frame = CGRectMake(0, 452-44, 52, 48);
//        
