...
@interface iphone4MainWallpapers ()

@end

@implementation iphone4MainWallpapers
@synthesize footerView,imageScroller,TAG,imgIndex,dwnloadProgress;
@synthesize logoTimer;
@synthesize faceBookBtn,twitterBtn,emailBtn,wallpaperView;
...
- (void)viewDidLoad
{
	...
	self.trackedViewName=@"Wallpaper Screen";
    imgIndex = 0;
...
- (void)loadCollection
{
	...
	vw_CollectionView					= [[UIView alloc] initWithFrame:CGRectMake(0, 50, 320, 280)];
	vw_CollectionView.alpha				= 1.0;
	[self.view addSubview:vw_CollectionView];
	
	ic_CoverFlow								= [[iCarousel alloc] initWithFrame:CGRectMake(0, 0, 320, 278)];
...
//        else
//        {
            data1[i]= [actoAgent objectForKey:@"big_image"];
            NSLog(@"big_image=%@",data1[i]);
            
            data2[i]= [actoAgent objectForKey:@"w_hd_image"];
            NSLog(@"w_hd_image=%@",data2[i]);
            
            
            NSString *timeZone =[actoAgent objectForKey:@"small_wall_id"];
            NSArray *newArray=[timeZone componentsSeparatedByString:@"_"];
            fbFeedId[i] = [actoAgent objectForKey:@"small_wall_id"];
            NSLog(@"data4  id ==== =====   %@",fbFeedId[i]);
            
            
            data3[i]= [actoAgent objectForKey:@"w_tiny_link"];
            NSLog(@"w_tiny_link=%@",data3[i]);
...
//    transform.m34 = ic_CoverFlow.perspective;
//    transform = CATransform3DRotate(transform, M_PI / 8.0, 0, 1.0, 0);
//   return CATransform3DTranslate(transform, 0.0, 0.0, offset * ic_CoverFlow.itemWidth);
//}
...
{
    ((AsyncImageView *)view).image = nil;
    //UIButton* button = (UIButton *)view;
    if (view == nil)
    {
        view = [[AsyncImageView alloc] initWithFrame:CGRectMake(0, 0, 200.0f, 300.0f)];
        
        view.contentMode = UIViewContentModeScaleAspectFill;
    }
    view.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"color_pacth_400x400.png"]];
    NSLog(@"INDEX>>>>***++++ = %d",index);
     NSLog(@"data10[]>>>>***++++ = %@",data10[index]);
    ...
    UIImageView *zoomButton = [[UIImageView alloc]initWithFrame:CGRectMake(200-47, 1, 44, 42)];
...
//    {
//        
//        premiumView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 200.0f, 300.0f)];
//        premiumView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"premi_wall_ip4.png"]];
...
//    if(_dwnloadButtonView.alpha == 0.0)
//    {
...

{
    ...
    imageScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(7,0,306,416)];
        ...
        
    {
            ...
            
        {
            ...
            view2[a] = [[AsyncImageView alloc] initWithFrame:CGRectMake(m+0, 0, 306.0f, 416.0f)];
      ...
      wallpaperView  = [[UIView alloc] initWithFrame:CGRectMake(m+0, 0, 306.0f, 416.0f)];
...
//        downloadButton[a] = [UIButton buttonWithType:UIButtonTypeCustom];
//        
//        downloadButton[a].frame = CGRectMake(0, 416-87, 52, 48);
//        
...
//        [wallpaperView addSubview:downloadButton[a]];
            ...
            downloadHD[a].frame = CGRectMake(0, 416-92, 52, 48);
            ...
            socializeBg[a] = [[UIView alloc]initWithFrame:CGRectMake(0, 416-44+4, 306, 44)];
...
//                downloadHD = [[UIButton alloc] initWithFrame:CGRectZero];
//               // downloadHD.titleLabel.text = @"HD";
//                [downloadHD setImage:[UIImage imageNamed:@"hd_icon.png"] forState:UIControlStateNormal];
//                [downloadHD sizeToFit];
//                [downloadHD addTarget:self action:@selector(downloadHDButton:) forControlEvents:UIControlEventTouchUpInside];
//                downloadHD.tag=a;
                
//                panicButton = [SZActionButton actionButtonWithIcon:nil title:@"HD"];
//                panicButton.actionBlock = ^(SZActionButton *button, SZActionBar *bar)
//                {
//                    [self performSelector:@selector(downloadHDButton:) withObject:nil afterDelay:0.0];
//                };
//                panicButton.tag=a;
                ...
                actionBar[a].betweenButtonsPadding=1.0;
...
//         
//        shareButton[a].frame = CGRectMake(260, 416-84, 52, 48);
//        
...
//        shareView[a] = [[UIView alloc]initWithFrame:CGRectMake(265, 210, 42, 133)];
//        
...
//        [wallpaperView addSubview:shareView[a]];
    ...
    imageScroller.contentSize = CGSizeMake(306*TotalData, 395);
