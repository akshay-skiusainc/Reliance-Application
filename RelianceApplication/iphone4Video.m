...
@interface iphone4Video ()

@end

@implementation iphone4Video
@synthesize Scroller = _Scroller;
@synthesize LOGINVIEW,sharebtn,footerView,IAPVIEWScroller;
...
- (void)viewDidLoad
{
	...
	//self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"iph4home_main_bg.jpg"]];
...
-(void)DisplayVideos
{
	...
	VideoScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(10,0,299,416)];
	...
	for (int i =0; i<TotalData; i++) {
		...
		webwall[i]                    = [[UIWebView alloc] initWithFrame:CGRectMake(0, m, 299,187)];
        ...
        ImagePatch[i]                    = [[UIImageView alloc] initWithFrame:CGRectMake(0, 187-40, 320,40)];
		...
		MusicLabel[i] = [[UILabel alloc] initWithFrame:CGRectMake(5, 187-25, 320-25-5, 20)];
        ...
        infoVideo[i].frame				= CGRectMake(299-25,187-30,25,25);
        ...
        gapView[i] = [[UIView alloc]initWithFrame:CGRectMake(0, m+187, 299,1)];
        ...
        {
            lockImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 299,187)];
...
//        }
	...
	VideoScroller.contentSize = CGSizeMake(299,188*(TotalData+0)+20);
