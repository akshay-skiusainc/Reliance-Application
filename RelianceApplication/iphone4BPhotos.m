...
@interface iphone4BPhotos ()

@end

@implementation iphone4BPhotos
@synthesize footerView,imageScroller,imgIndex,logoTimer,dwnloadProgress;
...
- (void)viewDidLoad
{
	...
	//self.trackedViewName=@"Behind The Scenes Photos";
    _dwnloadButtonView.alpha = 0.0;
    _fbtwitShareView.alpha = 0.0;
    _sharebtn.alpha = 0.0;
...

{
        ...
        
    {
        ...
        UIView *wallpaperView = [[UIView alloc] initWithFrame:CGRectMake(m+0, 0, 306.0f, 416.0f)];
...
//        downloadButton[a] = [UIButton buttonWithType:UIButtonTypeCustom];
//        
//        downloadButton[a].frame = CGRectMake(0, 345, 52, 48);
//        
...
//        [wallpaperView addSubview:downloadButton[a]];
            ...
            socializeBg[a] = [[UIView alloc]initWithFrame:CGRectMake(0, 416-45, 306, 44)];
            ...
            if (actionBar[a] == nil)
            {
                ...
                NSString *entity_Key= [NSString stringWithFormat:@"%@",data3[a]];
...
//
//        shareButton[a].frame = CGRectMake(260, 345, 52, 48);
//        
...
-(void)displayComposerSheet:(NSString*)String
{
    ...
    NSString	*str= [NSString stringWithFormat:@"%@ \n\n You can also download Behind The Scene HD image from %@",mailsharetext,data2[imgIndex]];    [picker setToRecipients:toRecipients];
