...
@interface iphone5Notification ()

@end

@implementation iphone5Notification
...
//        NSString    *str=[NSString stringWithFormat:@"Reliance Entertainment %d",i+1];
