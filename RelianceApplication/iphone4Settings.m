...
@interface iphone4Settings ()

@end

@implementation iphone4Settings
...
- (IBAction)helpviewcontroller:(id)sender {
	iphone4HelpViewController *profile = [[iphone4HelpViewController alloc]initWithNibName:@"iphone4HelpViewController" bundle:nil];
    	[self.navigationController pushViewController:profile animated:YES];
    //[self presentViewController:profile animated:YES completion:nil];
}
- (IBAction)profileButton:(id)sender {
    iphone4ProfileViewController *profile = [[iphone4ProfileViewController alloc]initWithNibName:@"iphone4ProfileViewController" bundle:nil];
        [self.navigationController pushViewController:profile animated:YES];
   // [self presentViewController:profile animated:YES completion:nil];
}
...
- (IBAction)termsButton:(id)sender {
    iphone4PolicyViewController *policy = [[iphone4PolicyViewController alloc]initWithNibName:@"iphone4PolicyViewController" bundle:nil];
...
- (IBAction)contactButton:(id)sender {
    iphone4ContactUsViewController *contactUs = [[iphone4ContactUsViewController alloc]initWithNibName:@"iphone4ContactUsViewController" bundle:nil];
...
- (IBAction)aboutButton:(id)sender {
    ...
    iphone4AboutInfoViewController *aboutVC=[[iphone4AboutInfoViewController alloc]initWithNibName:@"iphone4AboutInfoViewController" bundle:nil];
