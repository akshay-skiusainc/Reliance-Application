//
//  iphone4ContestViewController.m
//  Relapp
//
...
#import "iphone4ObjectiveViewController.h"
#import "iphone4SubjectiveViewController.h"
#import "BackgroundLayer.h"
#import "iphone4Merchandise.h"
#import "iphone4Settings.h"
#import "GroupViewController.h"

@interface iphone4ContestViewController ()

@end
@implementation iphone4ContestViewController
...
-(void)fetchAllData
{
	...
	NSString* post = [NSString stringWithFormat:@"http://apps.medialabs24x7.com/besharam/fetch_data_contest_ios.php?deviceno=%@",obj.dev];
    ...
    dispatch_async(dispatch_get_main_queue()	, ^{
        ...
        for (NSDictionary *actoAgent in obj.contestData)
        {
            ...
            if ([data1[0] isEqualToString:@"FAIL"])
            {
                ...
                data3[i]= [actoAgent objectForKey:@"types"];
                
                
                data4[i]= [NSString stringWithFormat:@"%@",[actoAgent objectForKey:@"title"]];
                ...
                data18[i]= [actoAgent objectForKey:@"description"];
                
                
                data1[i]= [actoAgent objectForKey:@"thumb_image"];
                
                
                data5[i]= [actoAgent objectForKey:@"question"];
                
                
                data6[i]= [actoAgent objectForKey:@"answer1"];
                
                
                data7[i]= [actoAgent objectForKey:@"answer2"];
                
                
                data8[i]= [actoAgent objectForKey:@"answer3"];
                
                
                
                data9[i]= [actoAgent objectForKey:@"answer4"];
                
                
                data10[i]= [actoAgent objectForKey:@"correctans"];
...
//    poasterImage.image=image;
    ...
    if (poasterImage    == nil)
    {
        poasterImage = [[AsyncImageView alloc] initWithFrame:CGRectMake(9, 1, 300, 171)];
    ...
    if (TotalData>1) {
        contestScroll			= [[UIScrollView alloc] initWithFrame:CGRectMake(4,177,310,217)];
        ...
        for (int i =1; i<TotalData; i++)
        {
            ...
            if (cellImage[i]    == nil)
            {
                ...
                cellImage[i].contentMode = UIViewContentModeScaleAspectFit;
            }
            ...
            [self.self.contestScroll addSubview:cellImage[i]];
...
-(void)openContest:(UIButton*)sender
{
    ...
    if ([strCheck isEqualToString:@"1"]) {
        ...
        iphone4SubjectiveViewController *subVC=[[iphone4SubjectiveViewController alloc]initWithNibName:@"iphone4SubjectiveViewController" bundle:nil];
    ...
    {
        iphone4ObjectiveViewController *objVC=[[iphone4ObjectiveViewController alloc]initWithNibName:@"iphone4ObjectiveViewController" bundle:nil];
