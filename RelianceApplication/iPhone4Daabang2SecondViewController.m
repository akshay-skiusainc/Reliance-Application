...
@interface iPhone4Daabang2SecondViewController ()

@end

@implementation iPhone4Daabang2SecondViewController
...
//		self.navigationItem.leftBarButtonItem = customBarItem;
    ...
    if (result) {
        ...
        NSLog(@"Location services disabeld");
    }
...
//    [ImageBck release];
    ...
    ActIndImage = [[UIImageView alloc] initWithFrame:CGRectMake(0,0,320,416)];
  //  ActIndImage.center = CGPointMake(320/2, 460/2);
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(100,0,236,40)];
    ...
    UIImageView *redDividerImage = [[UIImageView alloc]initWithFrame:CGRectMake(20, 33, 280, 2)];
    redDividerImage.image = [UIImage imageNamed:@"wall_title_border.jpg"];
    [self.view addSubview:redDividerImage];
    
//    _footerMainView = [[UIView alloc]initWithFrame:CGRectMake(0, 398, 320, 77)];
//    _footerMainView.backgroundColor = [UIColor clearColor];
//    
//    UIImageView *openFooterImage = [[UIImageView alloc]initWithFrame:CGRectMake(143, 1, 35, 17)];
//    openFooterImage.image = [UIImage imageNamed:@"footer_down_btn.png"];
//    [_footerMainView addSubview:openFooterImage];
//    
//    footerView = [[UIView alloc]initWithFrame:CGRectMake(0, 20, 320, 57)];
...
//    
//    
//    merchandiseButton = [[UIButton alloc] initWithFrame:CGRectMake(113, 5, 76, 42)];
...
//    
//    chatButton = [[UIButton alloc] initWithFrame:CGRectMake(194, 10, 41, 42)];
...
//    
//    myProfileButton = [[UIButton alloc] initWithFrame:CGRectMake(250, 9, 62, 42)];
...
//    [_footerMainView addSubview:footerView];
...
-(void)A1
{
    ...
    iPhone4InSingleTheather *dvController = [[iPhone4InSingleTheather alloc] initWithNibName:@"iPhone4InSingleTheather" bundle:[NSBundle mainBundle]];
...
//    NSString* post = [NSString
//                      stringWithFormat:@"http://apps.micrositeads.com/besharam/get_loc_rel.php?lat=19.1738634&lng=72.8440463"];
//    NSString* post = [NSString
...
-(void)DisplayTheaterList
{
    ...
    VideoScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(0,40,320,347)];
    ...
    for (int i =0; i<TotalNumOfRows; i++) {
        ...
        ImagePatch1[i]  = [[UIImageView alloc] initWithFrame:CGRectMake(0, m, 320,70)];
      ...
      //  ImagePatch1[i].tag= i;
        ...
        ImagePatch[i]  = [[UIImageView alloc] initWithFrame:CGRectMake(0, m, 320,70)];
        ...
        [tapped123 release];
 	    ...
 	    geometry = [[UIImageView alloc] initWithFrame:CGRectMake(260,10, 47 , 47)];
        ...
        Th_add_Lbl[i]			=	[[UILabel alloc] initWithFrame:CGRectMake(5, 40,230,20)];
    ...
    VideoScroller.contentSize = CGSizeMake(320,(71*TotalNumOfRows+20));
