...
@interface R_iphone5HelpViewController ()

@end

@implementation R_iphone5HelpViewController
...
- (void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	R_iphone5help2ViewController *help = [[R_iphone5help2ViewController alloc] initWithNibName:@"R_iphone5help2ViewController" bundle:nil];
