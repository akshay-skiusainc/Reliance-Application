...
@interface R_wallpapers_5 : DatabaseClass<UIWebViewDelegate,UIScrollViewDelegate, UIGestureRecognizerDelegate,MFMailComposeViewControllerDelegate,SocializeServiceDelegate,UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
