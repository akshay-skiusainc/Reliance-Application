//
//  R_iPhone5ContestViewController.m
//  RelianceApplication
//
...
#import "R_iPhone5ObjectiveViewController.h"
#import "R_iPhone5SubjectiveViewController.h"
#import "AsyncImageView.h"
#import "iphone5Settings.h"

@interface R_iPhone5ContestViewController ()

@end

@implementation R_iPhone5ContestViewController
...
-(void)DisplayContests
{
    ...
    contestScroll			= [[UIScrollView alloc] initWithFrame:CGRectMake(5,54,310,444)];
    ...
    else
    {
            ...
            poasterImage = [[AsyncImageView alloc] initWithFrame:CGRectMake(5, 54, 310, 173)];
...
-(void)openContest:(UIButton*)sender
{
    ...
    if ([strCheck isEqualToString:@"1"]) {
        ...
        R_iphone5SubjectiveViewController *subVC=[[R_iphone5SubjectiveViewController alloc]initWithNibName:@"R_iphone5SubjectiveViewController" bundle:nil];
    ...
    {
        R_iphone5ObjectiveViewController *objVC=[[R_iphone5ObjectiveViewController alloc]initWithNibName:@"R_iphone5ObjectiveViewController" bundle:nil];
