//
//  iphone4ObjectiveViewController.m
//  Relapp
//
...
@implementation iphone4ObjectiveViewController
...
-(IBAction)ANSSELECTED:(UIButton*)sender
{
    if ([sender tag]==0) {
        ...
        [ANS1BUTTON setBackgroundImage:[UIImage imageNamed:@"check_box_icon.png"] forState:UIControlStateNormal];
        [ANS2BUTTON setBackgroundImage:[UIImage imageNamed:@"uncheck_box_icon.png"] forState:UIControlStateNormal];
        [ANS3BUTTON setBackgroundImage:[UIImage imageNamed:@"uncheck_box_icon.png"] forState:UIControlStateNormal];
        [ANS4BUTTON setBackgroundImage:[UIImage imageNamed:@"uncheck_box_icon.png"] forState:UIControlStateNormal];
    ...
    if ([sender tag]==1) {
        ...
        [ANS2BUTTON setBackgroundImage:[UIImage imageNamed:@"check_box_icon.png"] forState:UIControlStateNormal];
        selectedans= ans2label.text;
        
        [ANS1BUTTON setBackgroundImage:[UIImage imageNamed:@"uncheck_box_icon.png"] forState:UIControlStateNormal];
        [ANS3BUTTON setBackgroundImage:[UIImage imageNamed:@"uncheck_box_icon.png"] forState:UIControlStateNormal];
        [ANS4BUTTON setBackgroundImage:[UIImage imageNamed:@"uncheck_box_icon.png"] forState:UIControlStateNormal];
    ...
    if ([sender tag]==2) {
        ...
        [ANS3BUTTON setBackgroundImage:[UIImage imageNamed:@"check_box_icon.png"] forState:UIControlStateNormal];
        ...
        [ANS4BUTTON setBackgroundImage:[UIImage imageNamed:@"check_box_icon.png"] forState:UIControlStateNormal];
