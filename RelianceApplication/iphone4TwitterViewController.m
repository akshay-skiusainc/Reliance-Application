//
//  iphone4TwitterViewController.m
//  RelianceApplication
//
...
@interface iphone4TwitterViewController ()

@end

@implementation iphone4TwitterViewController
...
-(void)DisplayFeeds
{
	...
	VideoScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(0,33,320,389)];
	...
	for (int i =0; i<TotalNumOfRows; i++) {
        ...
        if (actionBar[i] == nil)
        {
            ...
            actionBar[i].itemsRight = [NSArray arrayWithObjects:faceBookBtn, nil];
