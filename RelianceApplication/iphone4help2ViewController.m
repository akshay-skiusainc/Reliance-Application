...
@interface iphone4help2ViewController ()

@end

@implementation iphone4help2ViewController
...
-(void)loadtable
{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(10, 40, 300, 504-20) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGRect tableFrame = CGRectMake(10, 40, 300, size.height+70);
