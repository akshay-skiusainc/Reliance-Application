...
@interface R_FeedsVC_5 ()

@end

@implementation R_FeedsVC_5


@synthesize FEEDTAG,faceBookButton,twitterButton;
@synthesize m,loaderCount,currentScrollPosition,finalCount;
...
-(void)DisplayFeedsTweets
{
    ...
    VideoScrollerTweet			= [[UIScrollView alloc] initWithFrame:CGRectMake(8,100,304,404)];
...
-(void)DisplayFeeds
{
	...
	VideoScroller			= [[UIScrollView alloc] initWithFrame:CGRectMake(8,100,304,404)];
