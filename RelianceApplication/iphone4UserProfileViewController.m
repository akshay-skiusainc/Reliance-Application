//
//  iphone4UserProfileViewController.m
//  RelianceApplication
//
...
@interface iphone4UserProfileViewController ()

@end

@implementation iphone4UserProfileViewController
@synthesize  likeBtn,commentBtn,profileBtn,likeLable,commentLable,appInfoBtn,currentUser,profileActivityIndicator,socialProfileImage,cameraBtn,popover,cameraTag,sharingBtnImg,scrollView,sharingBtn;
@synthesize fbSwitch,twtSwitch;
