...
//  RelianceApplication
//
//  Created by Ashwini Pawar on 24/10/13.
//  Copyright (c) 2013 Akshay. All rights reserved.
//

#import "R_Trailers_4.h"
#import "R_OpenStills_4.h"

@interface R_Trailers_4 ()

@end

@implementation R_Trailers_4
...
//    if ([obj.REL_DATA isEqualToString:@"0"]) {
        ...
        else
        {
            ...
            if (!errorReturned) {
                ...
                obj.rel_RightNavMovieLogo = RightNavMovieLogo;                //  obj.Contests=Contests;
                //
...
//            [stillTable reloadData];
    ...
    activityIndicator2.center=CGPointMake(320/2, 405);
...
//     if(stillTable.hidden == NO)
    if(check==1)

    {
        NSLog(@"DisplayFilmStills11");
...
-(void)DisplayVideos
{
	...
	VideoScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(5,110,320,306)];
	...
	for (int a =loaderCount; a<loaderCount+finalCount; a++)
    {
        ...
        if([data17[a]isEqualToString:movieSearch.text])
        {
            ...
            if ([data11[a] isEqualToString:@"1"])
            {
                ...
                lockImageStills[a] = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 314,200)];
        ...
        if([movieSearch.text isEqualToString:@"All"])
        {
            ...
            if ([data11[a] isEqualToString:@"1"])
            {
                ...
                lockImageStills[a] = [[UIImageView alloc]initWithFrame:CGRectMake(nX,nY,150,200)];
                lockImageStills[a].image = [UIImage imageNamed:@"premi_video.png"];
                [view3[a] addSubview:lockImageStills[a]];
                }
            }
...
-(void)DisplayFilmStills
{
    ...
    Scroller = [[UIScrollView alloc] initWithFrame:CGRectMake(5,110,320,306)];
    ...
    if([movieSearch.text isEqualToString:@"All"])
    {
        for (int a =0; a<5; a++)
        {
            ...
            if ([data15[a] isEqualToString:@"1"])
            {
                ...
                lockImageStills[a] = [[UIImageView alloc]initWithFrame:CGRectMake(0,0, 150.0, 207.0)];
                lockImageStills[a].image = [UIImage imageNamed:@"premi_video.png"];
                [view3[a] addSubview:lockImageStills[a]];
                }
            }
...
- (void)imageTouched:(UITapGestureRecognizer *)sender
{
    ...
    {
    R_OpenStills_4 *openStills = [[R_OpenStills_4 alloc]initWithNibName:@"R_OpenStills_4" bundle:nil];
