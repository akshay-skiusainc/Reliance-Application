...
@synthesize tagApply,smallDescStr,detailDescStr,imageStr,middleView,closeButtonView,Scroller;
@synthesize bigSmallDesc,bigDetailDesc,bigActivityIndicator,bigNewsImage,fbTweetView,footerView;
@synthesize faceBookBtn,twitterBtn,emailBtn,socializeBg,actionBar;
@synthesize  newsID;
...
-(void)loadNews
{
    ...
    if (bigNewsImage    == nil)
    {
        bigNewsImage = [[AsyncImageView alloc] initWithFrame:CGRectMake(0, 0, 298, 133)];
