...
@interface NewsViewController : DatabaseClass <UIGestureRecognizerDelegate>
{
...
@property (strong, nonatomic) IBOutlet UIActivityIndicatorView *mainActivityinadicator;
