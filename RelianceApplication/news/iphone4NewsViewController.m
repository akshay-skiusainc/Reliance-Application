...
@interface iphone4NewsViewController ()

@end

@implementation iphone4NewsViewController
@synthesize Scroller,newsScroll,shareButton,bigBackView,bigNewsImage,bigActivityIndicator,bigDetailDesc,bigSmallDesc,footerView;
...
-(void)DisplayNews
{
    ...
    int m = 0;
    Scroller = [[UIScrollView alloc] initWithFrame:CGRectMake(0,15,320,401)];
    ...
    for(int a=0;a<TotalData;a++)
    {
		...
		smallDesc[a].font = [UIFont fontWithName:@"Helvetica Neue" size: 18.0];
...
- (void)openNews:(UIButton *)sender
{
    ...
    NSLog(@"okokokok");
    iphone4OpenNewsViewController *openNewsVC = [[iphone4OpenNewsViewController alloc]initWithNibName:@"iphone4OpenNewsViewController" bundle:nil];
