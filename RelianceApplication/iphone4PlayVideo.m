...
@interface iphone4PlayVideo ()

@end

@implementation iphone4PlayVideo
...
- (void)viewDidLoad
{
    ...
    shareView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"v_f_btnbg"]];
    [super viewDidLoad];
	...
	ActIndImage = [[UIImageView alloc] initWithFrame:CGRectMake(0,42,460,298)];
	...
	activityIndicator.center=CGPointMake(460/2, 298/2);
	...
	[self performSelector:@selector(unloadAct) withObject:nil afterDelay:2.0];
     ...
     [self.view addSubview:_socializebg];
