...
@interface R_OpenMovie_5 ()

@end

@implementation R_OpenMovie_5
...
-(void)displayShortClips
{
    ...
    VideoScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(6,249,308,255)];
...
-(IBAction)navigate:(id)sender
{
    ...
    loginViewController.idis =data10[gesture.view.tag];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSLog(@"data8 = %@",data8[indexPath.row]);
    cell.selectionStyle = UITableViewCellSelectionStyleNone;

    
    //    cell.imageView.image = _image1;
    //    cell.imageView.imageURL =[NSURL URLWithString:data6[indexPath.row]];
...
-(IBAction)OpenTrailers:(id)sender
{
    ...
    R_Trailers_5 *trailers = [[R_Trailers_5 alloc] initWithNibName:@"R_Trailers_5" bundle:nil];
