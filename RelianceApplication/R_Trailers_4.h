...
@interface R_Trailers_4 :  DatabaseClass<UIScrollViewDelegate,UIWebViewDelegate,UIGestureRecognizerDelegate,SocializeActionBarDelegate,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate>
{
    int check;
