...
@interface iphone4PolicyViewController ()

@end

@implementation iphone4PolicyViewController
...
- (void)viewDidLoad
{
    ...
    //self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"policies_bg.jpg"]];
