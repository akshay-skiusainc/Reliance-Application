...
-(void)DisplayMerchandiseData
{
	...
	VideoScroller			= [[UIScrollView alloc] initWithFrame:CGRectMake(0,0,320,504)];
	...
	for (int i =0; i<TotalData; i++) {
        ...
        ImagePatch[i]                    = [[UIImageView alloc] initWithFrame:CGRectMake(7, m, 306,377)];
       ...
       ImagePatch[i].alpha=0.46;
        ...
        if (Imageview[i]    == nil)
        {
            Imageview[i] = [[AsyncImageView alloc] initWithFrame:CGRectMake(54, 20+m, 209.0f, 230.0f)];
        ...
        ImagePatch2[i]                    = [[UIImageView alloc] initWithFrame:CGRectMake(8, 380+m, 308,120)];
        ...
        Description[i] = [[UITextView alloc] initWithFrame:CGRectMake(0, 0, 305, 83)];
        ...
        Description[i].font = [UIFont boldSystemFontOfSize:14.0f];
       // Description[i].font = [UIFont italicSystemFontOfSize:16.0f];
        ...
        pricebtn[i].frame				= CGRectMake(10,m+325,133,50);
     ...
     //   [pricebtn[i] setBackgroundImage:shre1 forState:UIControlStateHighlighted];
        ...
        leftbtn[i].frame				= CGRectMake(10,247+m,72,72);
        ...
        rightbtn[i].frame				= CGRectMake(308-75,247+m,72,72);
        ...
        title[i].font = [UIFont boldSystemFontOfSize:14.0f];
        
		[ImagePatch[i] addSubview:title[i]];
        
        buybtn[i]					= [UIButton buttonWithType:UIButtonTypeCustom];
        buybtn[i].frame				= CGRectMake(201,m+333,103,42);
    ...
    /*    socializeBg[i] = [[UIView alloc]initWithFrame:CGRectMake(8, 442+m,308,44)];
...
//            faceBookBtn.tag=i;
    ...
    */    
	...
	VideoScroller.contentSize = CGSizeMake(320,(504*(TotalData)));
    
    //////paggin

    upDownArrow= [[UIImageView alloc] initWithFrame:CGRectMake(320-48, 504-32, 48,32)];
...
//    for (int i=0; i<TotalData; i++) {
//        if (VideoScroller.contentOffset.y == 510*i) {
//            for (int i=0; i<TotalData; i++) {
//                PAGINGEFFECT[i].image= [UIImage imageNamed:@"iph5cnc_black_dot.png"];
//                
//            }
...
//    buttonChat.frame = CGRectMake(50, 0, relAppImage.size.width, relAppImage.size.height);
//    [buttonChat addTarget:self action:@selector(toRelApp:) forControlEvents:UIControlEventTouchUpInside];
    ...
    //    UIBarButtonItem *btnShare = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(opencart:)];
    ...
    //   [self.navigationItem setRightBarButtonItems:[NSArray arrayWithObjects: customBarItem1, customBarItem11, nil]];
    
//    UIView* rightItem = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 150, 44)];
//    //Create UIButton1 b1
//    //Create UIButton2 b2
//    [rightItem addSubview:buttonChat];
//    [rightItem addSubview:buttonChat1];
//    
...
- (IBAction)tweetShare:(UIButton *)sender {
    ...
    GlobalClass *obj=[GlobalClass getInstance];
        ...
        [tweetSheet setInitialText:data14[sender.tag]];
	...
	if (![tweetSheet addURL:[NSURL URLWithString:data12[sender.tag]]]){
...
//        NSLog(@"data11=%@",data11[sharetag]);
//
//        if ([data11[sharetag] isEqualToString:@"T-shirt"]) {
//            [fbController setInitialText:[obj.Tshirt objectForKey:@"fb_share"]];
//            
//        }
//        
//        else   if ([data11[sharetag] isEqualToString:@"Mug"]) {
//            [fbController setInitialText:[obj.mug objectForKey:@"fb_share"]];
//            
//        }
//
//        
...

{
   ...
   // currentScrollPosition= VideoScroller.contentOffset.y;
    ...
    if(VideoScroller.contentOffset.y <= 504)
    {
        upDownArrow.image = [UIImage imageNamed:@"bottom.png"];
    }
    
    if ( VideoScroller.contentOffset.y+504 >= VideoScroller.contentSize.height)
    {
