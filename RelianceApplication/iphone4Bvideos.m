...
@interface iphone4Bvideos ()

@end

@implementation iphone4Bvideos
...
//    self.navigationItem.RightBarButtonItem = customBarItem1;
    ...
    self.trackedViewName=@"Behind the scene Videos";
...
-(void)DisplayVideos
{
	...
	VideoScroller			= [[UIScrollView alloc] initWithFrame:CGRectMake(10,5,299,411)];
	...
	for (int i =0; i<TotalData; i++) {
        ...
        ImagePatch[i]                    = [[UIImageView alloc] initWithFrame:CGRectMake(0, m+187-40, 320,40)];
		...
		MusicLabel[i] = [[UILabel alloc] initWithFrame:CGRectMake(5, 187-25+m, 320-25-5, 30)];
        ...
        //
        //
        //        UITapGestureRecognizer *tapped = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(VideoInfo:)];
	...
	VideoScroller.contentSize = CGSizeMake(299,188*(TotalData+0)+65+35);
