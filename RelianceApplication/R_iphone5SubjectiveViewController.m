//
//  R_iphone5SubjectiveViewController.m
//  RelianceApplication
//
...
@interface R_iphone5SubjectiveViewController ()

@end

@implementation R_iphone5SubjectiveViewController

@synthesize Questionlabel,Questionis,QID,importedUrl,contestImage,data,selectedans,ansTextView;
...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:app_bg_image];    _footerView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"footer_bg.png"]];
