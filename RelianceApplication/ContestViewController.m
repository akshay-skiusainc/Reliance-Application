...
@synthesize data12,data13,data16,data17,activityIndicator;
...
//            NSLog(@"btn_image_link=%@",data17);
         ...
         if (poasterImage    == nil)
         {
             poasterImage = [[AsyncImageView alloc] initWithFrame:CGRectMake(5, 5, 310, 173)];
...
-(void)DisplayContests
{
    ...
    if (TotalData>1) {
        contestScroll			= [[UIScrollView alloc] initWithFrame:CGRectMake(5,181,310,303)];
...
//    NSString *strCheck=@"1";
    if ([strCheck isEqualToString:@"1"]) {
        ...
        SubjectiveViewController *subVC=[[SubjectiveViewController alloc]initWithNibName:@"SubjectiveViewController" bundle:nil];
...
//        [self presentModalViewController:subVC animated:YES];
    ...
    {
        ObjectiveViewController *objVC=[[ObjectiveViewController alloc]initWithNibName:@"ObjectiveViewController" bundle:nil];
