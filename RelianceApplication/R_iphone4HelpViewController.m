...
@interface R_iphone4HelpViewController ()

@end

@implementation R_iphone4HelpViewController
...
-(void)loadtable
{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 55, 320, 376) style:UITableViewStylePlain];
...
- (void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	R_iphone4help2ViewController *help = [[R_iphone4help2ViewController alloc] initWithNibName:@"R_iphone4help2ViewController" bundle:nil];
