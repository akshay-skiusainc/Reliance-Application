...
@interface iphone4BPhotos :  DatabaseClass<iCarouselDelegate, iCarouselDataSource,UIWebViewDelegate,UIGestureRecognizerDelegate,UIScrollViewDelegate,MFMailComposeViewControllerDelegate>
{
...
@property (strong, nonatomic) IBOutlet UIView *fbtwitShareView;
