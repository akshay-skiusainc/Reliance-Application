...
@interface R_FeedsVC :GAITrackedViewController<MFMailComposeViewControllerDelegate,UIGestureRecognizerDelegate,UIWebViewDelegate,UITextFieldDelegate,SocializeServiceDelegate,UIScrollViewDelegate>
{
