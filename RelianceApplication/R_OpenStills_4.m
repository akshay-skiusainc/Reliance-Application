...
@interface R_OpenStills_4 ()

@end

@implementation R_OpenStills_4
...

{
        ...
        
    {
        ...
        if([data9[a]isEqualToString:movieName])
        {
                ...
                
            {
                ...
                view2[a] = [[AsyncImageView alloc] initWithFrame:CGRectMake(m, 0, 320.0f, 416.0f)];
    ...
    imageScroller.contentSize = CGSizeMake(m, 416);
