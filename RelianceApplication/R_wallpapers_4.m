...
@interface R_wallpapers_4 ()

@end

@implementation R_wallpapers_4
...
-(void)loadCollection
{
    ...
    activityIndicator2.center=CGPointMake(320/2, 400);
    ...
    mainScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(5,83,315,416-83)];
    ...
    if([movieSearch.text isEqualToString:@"All"])
    {
        for (int a =0; a<5; a++)
        {
            ...
            mainScroller.contentSize = CGSizeMake(315, ((5*226)/2)+113);
...

{
    ...
    imageScroller = [[UIScrollView alloc] initWithFrame:CGRectMake(0,0,320,416)];
        ...
        
    {
        ...
        if([data4[a]isEqualToString:movieSearch.text])
        {
                ...
                
            {
                ...
                view2[a] = [[AsyncImageView alloc] initWithFrame:CGRectMake(m+0, 0, 320.0f, 416.0f)];
            ...
            downloadHD[a].frame = CGRectMake(145, 416-32, 49, 21);
